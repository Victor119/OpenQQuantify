...
class very_low_frequency(gr.top_block, Qt.QWidget):

    def __init__(self, 
                samp_rate, 
                fm, 
                fc, 
                fm_range=(20000, 25000, 100), 
                fc_range=(1000, 2000, 100)):
        ...
        self.settings = Qt.QSettings("GNU Radio", "very_low_frequency")
        ...
        self._fm_range = qtgui.Range(*fm_range, self.fm, min_length=1)
        ...
        self._fc_range = qtgui.Range(*fc_range, self.fc, min_length=1)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, fc, 1, 0, 0)
...
def generate_am_signal(sample_rate, modulation_frq, carrier_freq, duration, output_dir):
    qapp = Qt.QApplication(sys.argv)
    
    tb = very_low_frequency(
    ...
    output_dir_path = os.path.join(output_dir, f"bpsk_signal_{carrier_freq}_{modulation_frq}_{sample_rate}.dat")
...
def main():
    ...
    data_path = 'C:\\Users\\victor\\Documents\\OpenQuantify_unpaid_25_11_2024\\week_3\\dataset\\train\\VLF_BPSK'
    
    modulation_freq = [20000, 25000] #fm
    carrier_frequencies = [1000, 1500] #fc
    samp_rate = 200000
